...
<body>
    ...
    <?php
        ...
        if(!isset($_SESSION['UID'])){
            $_SESSION['ERROR_MSG'] = "Please login to view your listsings.";
        ...
        $stmt = $connection->prepare("SELECT *,  (endDate > current_date or endDate is NULL) as active from item where ownerID = ? and type = ? and sold = '0'  ORDER BY startDate DESC LIMIT ?, ?");
        $stmt->bind_param("isii", $UID, $type, $offset, $pageCount);
        $stmt->execute();
    ...
    <div class="container">
        ...
        <div class="card text-center">
                ...
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link <?php if($type == 'B') echo "active"; ?>"
                            href="userlisting.php?type=B">Buy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if($type == 'S') echo "active"; ?>"
                            href="userlisting.php?type=S">Sell</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                ...
                echo '<div class="col-lg-4 col-sm-6 mb-4">              
                        ...
                        echo '" alt="">';
                         echo       '<div class="card-body text-left">
                                    <h4 class="card-title">';
                                    echo '<a href="useritem.php?itemID='.$item['itemID'].'">' ; 
                                    echo $item['title'];
                                    echo '</a>';
                                    echo '</h4>';
            ...
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" href="userlisting.php?type=<?php echo $type?>&pageNo=<?php echo $pageNo-1 ?>"
                        aria-label="Previous">
                ...
                <li class="page-item">
                    <a class="page-link"
                        href="userlisting.php?type=<?php echo $type?>&pageNo=<?php echo $pageNo -1?>"><?php echo $pageNo ?></a>
                </li>
                <li class="page-item">
                    <a class="page-link"
                        href="userlisting.php?type=<?php echo $type?>&pageNo=<?php echo $pageNo ?>"><?php echo $pageNo +1 ?></a>
                </li>
                <li class="page-item">
                    <a class="page-link"
                        href="userlisting.php?type=<?php echo $type?>&pageNo=<?php echo $pageNo+1 ?>"><?php echo $pageNo + 2 ?></a>
                </li>
                <li class="page-item">
                    <a class="page-link" href="userlisting.php?type=<?php echo $type?>&pageNo=<?php echo $pageNo+1 ?>"
                        aria-label="Next">
