...
<?php include 'title.php' ?>
    ...
    <div class="container">
        ...
        <h1 class="display-3">A Warm Welcome!</h1>
            <p class="lead">To the FastTrade website where we assure the goods quality and the sellers credibility.</p>
    ...
    <!-- Page Content -->
    <div class="container">
        <h1 class="my-4">Items Categories</h1>
            <?php
        ...
        $stmt = $connection->prepare("
            select category.categoryID, category.categoryName,   max(item.picture) as picture from category left join item
