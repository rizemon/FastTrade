            ...
            if(isset($_POST["deletepic"])){
                ...
                !isset($_FILES['picture'])){
                    ...
                    if($picture != null){
                        ...
                        where UID = ?;");
                        $stmt->bind_param("sssssi",$username, $email, $gender, $contact, $picture, $UID);
                    }else{
                        $stmt = $connection->prepare("
                        UPDATE userinfo 
                        SET 
                        username=?, email=?, gender=?, contact=?
                        where UID = ?;");
                        $stmt->bind_param("ssssi",$username, $email, $gender, $contact, $UID);
                    }
                    $stmt->execute();
                    if($stmt->affected_rows >= 0){
                    ...
                    <div class="card-body">
                        ...
                        <form class="mt-3" method="POST" action="settings.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input value="<?php echo $user['username']; ?>" name="username" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-control" id="gender">
                                    <option value="" <?php if($user['gender'] == '') echo "selected" ?>></option>
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $user['contact'];?>" name="contact" type="text"
